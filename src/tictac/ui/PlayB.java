...
public class PlayB extends Pane {
    ...
    public PlayB() {
        ...
        singlePlayer.setTextFill(javafx.scene.paint.Color.valueOf("#930a0a"));
        ...
        twoPlayer.setTextFill(javafx.scene.paint.Color.valueOf("#930a0a"));
        ...
        playOnline.setTextFill(javafx.scene.paint.Color.valueOf("#930a0a"));
        ...
        replay.setTextFill(javafx.scene.paint.Color.valueOf("#930a0a"));
